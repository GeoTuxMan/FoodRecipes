...
1) Features: save recipes to a json file

2) Tech: React Native, Typescript, Expo

3) Screenshots

![Image of your image](img3.png)

![Image of your image](img2.png)

4) Installation

git clone https://github.com/GeoTuxMan/FoodRecipes.github
